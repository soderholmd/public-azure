...
The script uses the AzureOpenAI class from the OpenAI module to interact with the Azure OpenAI API. It defaults to GPT-3.5 (or whatever you save as AZURE_OAI_DEPLOYMENT), but has a flag to use GPT-4 instead. GPT-4 will provide better results but runs about 10x slower than GPT-3.5, and costs about 50% more.
